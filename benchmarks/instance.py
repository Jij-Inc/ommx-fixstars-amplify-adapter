...
def build_one_hot_preparation_instance(
    ...
    """Build an OMMX v2 counterpart of a prepared v3 benchmark Instance.

    OMMX v2 cannot represent Indicator or SOS1 as first-class constraints.
    Their v3 lowering results are therefore added directly as regular
    inequalities so Adapter conversion and decoding process comparable models.
    """
